...
class NotificationTypeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'description', 'template_title',
            'template_body', 'is_active'
        ]
...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Notification
        fields = [
            'id', 'notification_type_info', 'title', 'body', 'data',
            'status', 'status_display', 'time_ago', 'created_at',
            'sent_at', 'read_at'
        ]
        read_only_fields = [
            'id', 'notification_type_info', 'status_display',
            'time_ago', 'created_at', 'sent_at'
        ]
...
class NotificationCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Notification
        fields = [
            'user_id', 'notification_type_id', 'title', 'body', 'data'
        ]
...
class UserDeviceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserDevice
        fields = [
            'id', 'fcm_token', 'platform', 'platform_display',
...
class UserDeviceCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserDevice
        fields = [
            'fcm_token', 'platform', 'device_id', 'app_version'
        ]
    ...
    def validate(self, attrs):
        ...
        if not user_roles and not user_ids:
            raise serializers.ValidationError(
                "Debe especificar al menos user_roles o user_ids"
            )
...
class NotificationStatsSerializer(serializers.Serializer):
    ...
    by_type = serializers.ListSerializer(
