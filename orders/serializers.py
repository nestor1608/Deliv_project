...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderItem
        fields = ["id", "product", "product_id", "quantity", "unit_price", "total_price", "special_instructions"]
...
class OrderStatusHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "previous_status", "new_status", "changed_by_name", "notes", "timestamp"]
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "order_number", "scheduled_time", "created_at", "updated_at"]
    ...
    def create(self, validated_data):
        ...
        for item_data in items_data:
            try:
                ...
                raise serializers.ValidationError({"items": f"Producto con id {item_data['product_id']} no existe"})
