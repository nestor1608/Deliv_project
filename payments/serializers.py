...
class PaymentMethodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PaymentMethod
        fields = [
            'id', 'name', 'type', 'type_display', 'provider',
            'is_active', 'commission_percentage'
        ]
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payment
        fields = [
            'id', 'payment_id', 'external_payment_id', 'user_info',
            'payment_method_info', 'object_info', 'amount', 'commission',
            'net_amount', 'status', 'status_display', 'metadata',
            'failure_reason', 'created_at', 'updated_at', 'completed_at'
        ]
        read_only_fields = [
            'id', 'payment_id', 'user_info', 'payment_method_info',
            'object_info', 'commission', 'net_amount', 'status_display',
...
class PaymentCreateSerializer(serializers.ModelSerializer):
    ...
    object_type = serializers.ChoiceField(
        choices=[('order', 'Pedido'), ('trip', 'Viaje')],
        write_only=True
    )
    ...
    class Meta:
        model = Payment
        fields = [
            'object_type', 'object_id', 'payment_method', 'metadata'
        ]
...
class RefundSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Refund
        fields = [
            'id', 'refund_id', 'external_refund_id', 'payment_info',
            'amount', 'reason', 'status', 'status_display',
            'created_at', 'completed_at'
        ]
        read_only_fields = [
            'id', 'refund_id', 'payment_info', 'status_display',
            'created_at', 'completed_at'
        ]
...
class PaymentStatsSerializer(serializers.Serializer):
    ...
    by_method = serializers.ListSerializer(
