...
class DriverSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["user_info", "status", "rating", "total_trips", "total_earnings", "created_at"]
...
class TripRatingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TripRating
        fields = ["id", "trip_info", "rating_type", "rating", "comment", "created_at"]
...
class TripEstimateSerializer(serializers.Serializer):
    ...
    vehicle_type = serializers.ChoiceField(choices=Driver.VEHICLE_CHOICES, required=False, default="car")
