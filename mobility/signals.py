...
from .models import Trip, TripRating
    ...
    if created:
        ...
        if not success:
            ...
            fcm_service.send_notification(
                ...
                {"trip_id": instance.id, "type": "no_drivers_available"},
            )
            ...
            if old_instance.status != instance.status:
                ...
                if instance.status == "accepted":
                    fcm_service.send_notification(
                        ...
                        {"trip_id": instance.id, "type": "trip_accepted"},
                    )
                    ...
                    fcm_service.send_notification(
                        ...
                        {"trip_id": instance.id, "type": "driver_arrived"},
                    )
                    ...
                    fcm_service.send_notification(
                        ...
                        {"trip_id": instance.id, "type": "trip_completed"},
                    )
...
def update_driver_rating(sender, instance, created, **kwargs):
    ...
    if created and instance.rating_type == "customer_to_driver":
        ...
        ratings = TripRating.objects.filter(trip__driver=driver, rating_type="customer_to_driver")
