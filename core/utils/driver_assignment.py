...
class DriverAssignmentService:
    ...
    def find_nearest_driver(pickup_lat, pickup_lon, max_distance_km=15):
        ...
        for driver in available_drivers:
            distance = calculate_distance(pickup_lat, pickup_lon, driver.current_latitude, driver.current_longitude)

            if distance <= max_distance_km:
                candidates.append({"driver": driver, "distance": distance, "rating": driver.rating})
    ...
    def assign_trip_to_driver(trip):
        ...
        driver = DriverAssignmentService.find_nearest_driver(trip.pickup_latitude, trip.pickup_longitude)
        ...
        if driver:
            ...
            fcm_service.send_notification(
                ...
                {"trip_id": trip.id, "trip_number": trip.trip_number, "type": "new_trip_assignment"},
            )
